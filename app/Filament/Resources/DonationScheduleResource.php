        ...
        return $table
            ...
            ->filters([
                ...
                Filter::make('Next-7 days Rescue')
                    ->query(fn (Builder $query): Builder => $query->whereBetween('donation_date', [Carbon::now(), Carbon::now()->addDays(7)]))
                    ->toggle(),
                Filter::make('Next-30 days Rescue')
                    ->query(fn (Builder $query): Builder => $query->whereBetween('donation_date', [Carbon::now(), Carbon::now()->addDays(30)]))
                    ->toggle(),
