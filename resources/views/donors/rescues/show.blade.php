                ...
                <div
                    ...
                    <div>
                        <div class="flex justify-between">
                            ...
                            <a href="{{ route('donors.rescues.foods.create', ['id' => $rescue->id]) }}"
                        ...
                        <div class="flex flex-col gap-4 mt-6">
                            <div>
                                ...
                                <input type="text" name="donor_name" id="donor_name"
                                    ...
                                    placeholder="Nama" value="{{ $user->name }}" disabled>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                    placeholder="081234567890" value="{{ $user->email }}" disabled>
                            </div>
                            <div>
                                <label for="title"
                            ...
                            <form method="post" action="{{ route('rescues.update', ['rescue' => $rescue]) }}">
                                ...
                                <button type="submit"
                                    class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ajukan
                                    Penyelamatan Pangan</button>
                            </form>
                        </div>
                    </div>
                </div>
