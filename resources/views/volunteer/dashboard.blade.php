            ...
            <div>
                <div
                    ...
                    <ul class="flex flex-wrap -mb-px">
                        <li
                            class="{{ $active === 'diajukan' ? 'inline-block p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500' : 'inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300' }}">
                            <a href="rescues?status=diajukan" class="">Diajukan</a>
                        </li>
                        <li class="mr-2">
                            <a href="rescues?status=diproses"
                                class="{{ $active === 'diproses' ? 'inline-block p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500' : 'inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300' }}">Diproses</a>
                        </li>
                        <li class="mr-2">
                            <a href="rescues?status=diambil"
                                class="{{ $active === 'diambil' ? 'inline-block p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500' : 'inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300' }}">Diambil</a>
                        </li>
                        <li class="mr-2">
                    ...
                    <a href="{{ route('volunteer.rescues.edit', ['id' => $rescue->id]) }}">
                        <div
                            ...
                            <div class="flex justify-between mt-6">
                                <span
                                    class="font- block bg-blue-100 text-blue-800 capitalize text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">{{ $rescue->status }}</span>
                                <span
